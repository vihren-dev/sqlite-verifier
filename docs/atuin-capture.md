...
The shared entry point is `nix develop --command just atuin-native`. It selects
the capture shell for the locked Rust build, then runs both native suites with
