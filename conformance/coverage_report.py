...
def collect(root: Path, native: str) -> dict[str, object]:
    ...
    return {
        ...
        "semantic_support": {"modeled_statement_forms": ["ordinary CREATE TABLE", "nullable ALTER TABLE ADD COLUMN",
                             "explicit BEGIN / COMMIT / ROLLBACK", "bounded full-row literal INSERT",
                             "bounded single-assignment literal UPDATE with integer unique-key equality"],
                             "inventory_is_coverage_denominator": False,
